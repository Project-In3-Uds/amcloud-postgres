package cm.amcloud.platform.postgres;
...
// Rend cette classe un composant Spring et un CommandLineRunner
@Component
public class PostgresInstaller implements CommandLineRunner {
     ...
     */
    public void installPostgres() throws IOException, InterruptedException {
